...
function Post({ postProps }) {
    const { _id, title, content, comments, commentCount, like, likeCount, author, createdAt, tags , slug, statu, isEdited, editedAt, firstPublishDate, priority} = postProps;
    const pinned = priority >= 100;
